...
export class SRAClient {
  ...
  private readonly base_uri = 'https://some-random-api.ml/';
  ...
  public async brightness(avatar: string, brightness?: number) {
    return await this.api<any>("canvas/invertgreyscale", { avatar, brightness });
  }
  ...
  public async youtubeComment(avatar: string, username: string, comment: string) {
    return await this.api<any>("canvas/youtube-comment", { avatar, username, comment });
  }
  ...
  public async tweet(avatar: string, username: string, displayName: string, comment: string) {
    return await this.api<any>("canvas/tweet", { avatar, username, displayName, comment });
  }
